...
import { EstimateData, EstimateLine } from "./types";
...
interface EstimateLineItemsTableProps {
    ...
    updateLine: (lineId: string, field: keyof EstimateLine, value: any) => void;
}
            ...
            <CardContent className="pb-2">
                {estimate.lines.length === 0 ? (
                    <div className="text-center py-16 text-gray-500">
                        ...
                        <p className="text-gray-600 mb-6">Get started by adding your first estimate line item</p>
                        <Button 
                            onClick={addLine} 
                            variant="outline" 
