...
interface BillPaymentRecordModalProps {
    isOpen: boolean;
    onClose: () => void;
    billId: string;
    billNumber: string;
...
export default function BillPaymentRecordModal({
    isOpen,
    onClose,
    billId,
    billNumber,
            ...
            <DialogContent className="sm:max-w-md">
                <DialogHeader>
                    ...
                    <p className="text-sm text-gray-600">
                        Bill: {billNumber} • Amount Due: {formatCurrency(amountDue)}
                    </p>
                </DialogHeader>
