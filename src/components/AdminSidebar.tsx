...
import {
  Building2, Users, BarChart3, Home, Shield,
  DollarSign, BookOpen, ShoppingCart, Package, FileText,
  Warehouse, TrendingUp, CreditCard, Receipt, ChevronLeft,
  ChevronRight, ChevronDown, ChevronUp, LogOut
} from "lucide-react";
...
const navigationGroups = [
  {
    title: "Overview",
    items: [
      { title: "Dashboard", href: "/admin/dashboard", icon: Home, color: "text-blue-600" },
    ]
  },
  {
    title: "Global Management",
    items: [
      { title: "Companies", href: "/admin/companies", icon: Building2, color: "text-emerald-600" },
      { title: "Users & Roles", href: "/admin/users", icon: Users, color: "text-emerald-600" },
      { title: "User KYC", href: "/admin/kyc", icon: Shield, color: "text-emerald-600" },
      { title: "Business Proposals", href: "/admin/business-proposals", icon: FileText, color: "text-emerald-600" },
    ]
  },
  {
    title: "Financial",
    items: [
      { title: "Financial Dashboard", href: "/admin/financials/dashboard", icon: TrendingUp, color: "text-purple-600" },
      { title: "Chart of Accounts", href: "/admin/financials/accounts", icon: BookOpen, color: "text-purple-600" },
      { title: "Journal Entries", href: "/admin/financials/journal", icon: FileText, color: "text-purple-600" },
    ]
  },
  {
    title: "Sales & Purchases",
    items: [
      { title: "Sales Invoices", href: "/admin/sales/invoices", icon: Receipt, color: "text-orange-600" },
      { title: "Purchase Bills", href: "/admin/purchases/bills", icon: CreditCard, color: "text-orange-600" },
    ]
  },
  {
    title: "Operations",
    items: [
      { title: "Products & Services", href: "/admin/operations/products", icon: Package, color: "text-indigo-600" },
      { title: "Customers", href: "/admin/operations/customers", icon: Users, color: "text-indigo-600" },
      { title: "Suppliers", href: "/admin/operations/suppliers", icon: Building2, color: "text-indigo-600" },
      { title: "Inventory", href: "/admin/operations/inventory", icon: Warehouse, color: "text-indigo-600" },
    ]
  },
];
...
export function AdminSidebar({ isCollapsed, onToggle }: AdminSidebarProps) {
  ...
  return (
    <div className={cn(
      ...
      {/* Header */}
      <div className="border-b border-gray-200/60 bg-gradient-to-r from-blue-600 to-indigo-600 text-white">
            ...
            >
              ...
              <div
                className={cn(
                  ...
                  hasActiveItem ? "bg-blue-50 border border-blue-200" : "hover:bg-gray-50",
                ...
                {!isCollapsed ? (
                  <>
                    <h3 className={cn(
                      ...
                      hasActiveItem ? "text-blue-700" : "text-gray-500"
                    )}>
                      {group.title}
                    </h3>
                  ...
                  <div className={cn(
                    ...
                    hasActiveItem ? "bg-blue-500" : "bg-gray-300"
                  )} />
                )}
              </div>
      ...
      {/* Company Switcher */}
      <div className="px-2 py-2 border-t border-gray-200/60 bg-slate-50/50">
        ...
        {!isCollapsed ? (
          <div className="relative">
            ...
            >
              <div className="flex items-center gap-2.5">
                <div className="flex h-8 w-8 items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-xs font-semibold shadow-sm">
                ...
                <div className="flex flex-col flex-1">
                  ...
                  <p className="text-xs text-gray-500 truncate">{user?.email || "admin@synergetics.com"}</p>
          ...
          <div className="relative">
            <div
              ...
              onClick={() => setIsProfileOpen(!isProfileOpen)}
            >
              <div className="h-7 w-7 flex items-center justify-center rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-xs font-semibold shadow-sm">
                {profile?.full_name?.split(" ").map((n: string) => n[0]).join("").toUpperCase() || "A"}
              </div>
            </div>
