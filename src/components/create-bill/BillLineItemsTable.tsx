...
import { BillData, BillLine } from "./types";
...
interface BillLineItemsTableProps {
    ...
    updateLine: (lineId: string, field: keyof BillLine, value: any) => void;
}
                ...
                {bill.lines.length === 0 ? (
                    <div className="text-center py-16 text-gray-500">
                        <div className="mb-6">
                            ...
                            <p className="text-gray-600 mb-6">Get started by adding your first bill line item</p>
                            <Button 
                                onClick={addLine} 
                                variant="outline" 
                                className="rounded-full px-6 h-10 border-gray-20 hover:bg-gray-50 transition-colors"
                            >
                                <Plus className="h-4 w-4 mr-2" />
                                Add First Line Item
                            </Button>
                        ...
                        <Table>
                            <TableHeader className="bg-gray-50/30">
                                <TableRow className="hover:bg-gray-50/30">
                                    ...
                                    <TableHead className="font-semibold text-gray-700 py-3 px-4 text-right">Cost</TableHead>
                                    ...
                                    <TableRow key={line.id} className="hover:bg-gray-50/20 transition-colors">
                                        ...
                                        <TableCell className="py-3 px-4 text-right">
                                            <Input
                                                ...
                                                className="rounded-lg w-full h-9 text-right border-gray-200 focus:border-blue-30 focus:ring-blue-200 transition-colors text-sm"
                                                min="0"
                                                step="0.01"
                                            />
                                        </TableCell>
