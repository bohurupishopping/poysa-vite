...
import { PurchaseOrderData, PurchaseOrderLine } from "./types";
...
interface PurchaseOrderLineItemsTableProps {
    ...
    updateLine: (lineId: string, field: keyof PurchaseOrderLine, value: any) => void;
}
            ...
            <CardContent className="pb-2">
                {purchaseOrder.lines.length === 0 ? (
                    <div className="text-center py-16 text-gray-500">
                        ...
                        <p className="text-gray-600 mb-6">Get started by adding your first purchase order line item</p>
                        <Button 
                            onClick={addLine} 
                            variant="outline" 
